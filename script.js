...
// 'L','Voucher 2','Voucher 4','Air Pod','L','Voucher 1','Air Pod','Voucher 2','L','Voucher 3','L','Voucher 4',
...
const generateValue = (angleValue) => {
  for (let i of spinValues) {
    if (angleValue >= i.minDegree && angleValue <= i.maxDegree) {
      ...
      //text.innerHTML = te+' '+ te_spinitem_org + ' ' ;
      ...
      te_count_airpod   = document.fn.count_airpod.value*1;
      ...
      //alert(te_spinitem_org)
      
      te_rem='';
      if(te=='Air Pod' && te_count_airpod>=3)
      {
	   te='L';
      ...
      */
      ...
      if(te=='Voucher 2' && te_count_voucher_2>=4)
      {
	   te='L';
...
spinBtn.addEventListener("click", () => {
  ...
  calc_count();
  alert('Click OK');
  te_count_airpod = document.getElementById('count_airpod').value;
  te_count_voucher_1 = document.fn.count_voucher_1.value;
  te_count_voucher_2 = document.fn.count_voucher_2.value;
  te_count_voucher_3 = document.fn.count_voucher_3.value;
  te_count_voucher_4 = document.fn.count_voucher_4.value;
  
  te_counts=te_count_airpod+' '+te_count_voucher_1+' '+te_count_voucher_2+' '+te_count_voucher_3+' '+te_count_voucher_4;
  text.innerHTML = te_counts;	 
  //alert(te_counts)
  ...
  document.fn.spinitem_org.value = te;
  ...
  let rotationInterval = window.setInterval(() => {
    ...
    //alert(spinChart.options.rotation);
